...
public class AdminSaveRequestDto {
    ...
    // No changes are needed for role as it is managed in the backend and not input by users

    public AdminSaveRequestDto setName(String name) {
        this.name = name;
        return this;
    }

    public AdminSaveRequestDto setSurname(String surname) {
        this.surname = surname;
        return this;
    }

    public AdminSaveRequestDto setEmail(String email) {
        this.email = email;
        return this;
    }

    public AdminSaveRequestDto setPassword(String password) {
        this.password = password;
        return this;
    }

    public AdminSaveRequestDto setPhoneNumber(String phoneNumber) {
