...
public class UserSaveRequestDto {
    ...
    public UserSaveRequestDto setName(String name) {
        this.name = name;
        return this;
    }

    public UserSaveRequestDto setSurname(String surname) {
        this.surname = surname;
        return this;
    }

    public UserSaveRequestDto setEmail(String email) {
        this.email = email;
        return this;
    }

    public UserSaveRequestDto setPassword(String password) {
        this.password = password;
        return this;
    }

    public UserSaveRequestDto setPhoneNumber(String phoneNumber) {
